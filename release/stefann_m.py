...
with open('models/fannet.json', 'r') as fp:
    fannet = model_from_json(fp.read())
fannet.load_weights('models/fannet_weights.h5')
    ...
    while RUN_FLAG:
        ...
        while step == 2:
            ...
            if key == 27:
                ...
                try:
                    image_mask, image_edit = edit_char(image_edit, image_mask, contours, bndboxes, cntidx, chr(key), 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', fannet, colornet)
                except:
